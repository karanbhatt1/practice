...
app.get("/", (req, res) => {
  res.render("index",{def:"THIS IS BAND NAME GENERATOR👇"});
  //Step 1 - Make the get route work and render the index.ejs file.
});
app.post("/submit", (req, res) => {
  res.render("index",{randName:randomName(adj,noun)});
...
function randomName(adj,noun){
  var a = Math.random()*(adj.length);
  a = Math.floor(a);
  var b = Math.random()*(noun.length);
  b = Math.floor(b);

  var randomName = adj[a] + noun[b];
  return randomName;
}
console.log(randomName(adj,noun));
